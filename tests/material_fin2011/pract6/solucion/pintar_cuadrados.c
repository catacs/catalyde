...
/* el interes de este ejercicio es que veais como crear un bucle (en
   ...
   ojo! cada for sirve para repetir su interior "lado" veces, igual da poner:
   ...
   pero esto estaria mal:

   for (i=0; i<=lado; i=i+1)

   porque se repetiria lado+1 veces

   esto tambien estaria mal:

   for (i=1; i<lado; i=i+1)

   puesto que se repetiria lado-1 veces
