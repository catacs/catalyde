...
int puede_votar(int anyo_nacimiento,
		int mes_nacimiento,
		int dia_nacimiento) {
  /* convertir una fecha como 10/04/1989 en el numero 19890410
     basta con comparar ese numero con 19931120 */
  int numero_nacimiento = anyo_nacimiento*10000+mes_nacimiento*100+dia_nacimiento;
  int numero_votar      = (ANYO_VOTAR-18)*10000+MES_VOTAR*100+DIA_VOTAR;
  return (numero_nacimiento <= numero_votar);
}
