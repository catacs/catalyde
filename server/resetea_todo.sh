...
sleep 3
#node upload.js -H localhost -p 8123 -d ../test/practica_en_blanco/ -D $db &
# node upload_practice.js -H localhost -p 8123 -d ../test/practica_en_blanco/ -D $db &
# sleep 3
#node upload.js -H localhost -p 8123 -d ../test/practica0/ -D $db &
node upload_practice.js -H localhost -p 8123 -d ../test/practica0/ -D $db &
sleep 3
