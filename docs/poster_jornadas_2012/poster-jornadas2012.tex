...
\text{cstanciu@dsic.upv.es, jpastor@dsic.upv.es, sespana@dsic.upv.es}\\
...
\begin{lista}
    \item Normalmente el alumno no tiene acceso a una versión funcional del
...
\item Aunque proporcionar una solución compilada puede mejorar la
...
código donde el alumno puede escribir su solución. Pudiendo además, activarla y
desactivarla (se utiliza la solución correcta oculta).
...
\miitem Existe la opción de comprobar la validez de las distintas
partes realizadas por el alumno de manera independiente del programa
final.

\miitem Las diferentes partes de la práctica se pueden realizar en
  ejemplos sencillos y combinarse en un programa más complejo que el
  alumno puede probar. De esta forma, el alumno puede analizar, estudiar y probar
  dicho código.
...
todos los pasos intermedios rea\-li\-za\-dos por el alumno. Facilita la
...
grupo o que si varios alumnos se sienten en un mismo ordenador puedan
...
\item Resulta importante atraer a los alumnos con
